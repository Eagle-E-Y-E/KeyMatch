...
def generateBaseImage(image, sigma, assumed_blur):
    """ 
    * principle of Gaussian blurring: → applying σ₁ then σ₂ to an image is equivalent to applying σ_total
        σ_total = √(σ₁² + σ₂²)
        σ² = σ_assumed² + σ_diff²
    """
...
def computeNumberOfOctaves(image_shape):
    # return 4
    """estimates how many times the image can be downsampled (by a factor of 2) 
        until it becomes too small to process. → minimum shape 4*4"""
...
def findKeypoints(gaussian_images, dog_images, num_intervals, sigma, image_border_width, contrast_threshold=0.04):
...
def computeKeypointsAndDescriptors(image, sigma=1.6, num_intervals=3, assumed_blur=0.5, image_border_width=5):
    ...
    assumed_blur → is the amount of blur assumed in the input image
    """
    ...
    keypoints = findKeypoints(gaussian_images, dog_images, num_intervals, sigma, image_border_width)
